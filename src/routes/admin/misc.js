...
// SQL PLAYGROUND
// -----------------------------------------------------------------------------
router.post("/api/admin/sql-playground", requireAdmin, requireDb, async (req, res) => {
...
// RESEARCH CACHE
// -----------------------------------------------------------------------------
router.get("/api/admin/research-cache", requireAdmin, requireDb, async (req, res) => {
...
router.delete("/api/admin/research-cache/:id", requireAdmin, requireDb, async (req, res) => {
...
// LOGS
// -----------------------------------------------------------------------------
router.get("/api/admin/logs", requireAdmin, requireDb, async (req, res) => {
  const [rows] = await pool.query(
