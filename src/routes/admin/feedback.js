...
router.post("/api/admin/feedback/:id/approve", requireAdmin, requireDb, async (req, res) => {
...
router.post("/api/admin/feedback/:id/reject", requireAdmin, requireDb, async (req, res) => {
  const id = Number(req.params.id);
